...
$(document).ready(function(){
    ...
    e.preventDefault();
    let getFormData = $('#contact_us_form')[0];  // Get form       
    let formData = new FormData(getFormData);  // FormData object 
    ...
    $.ajax({
        ...
        success: function (data) {
            if (data.status) {
                ...
                $(".form-group").html("");
                $(".form-group").html(`<div class="messages-container">
